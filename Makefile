...
RottenEconomy-Server.zip:
	...
	@ln -s ./ ./RottenEconomy
	zip -r RottenEconomy-Server.zip ./RottenEconomy/mods ./RottenEconomy/config ./RottenEconomy/scripts ./RottenEconomy/resources ./RottenEconomy/adverts ./RottenEconomy/libraries ./RottenEconomy/README.md ./RottenEconomy/CHANGELOG.md ./RottenEconomy/LICENSE ./RottenEconomy/start.sh ./RottenEconomy/server.properties.example ./RottenEconomy/forge-1.12.2-14.23.5.2855.jar ./RottenEconomy/minecraft_server.1.12.2.jar -x "./RottenEconomy/mods/OptiFine*" -x "./RottenEconomy/mods/controllable-*" -x "./RottenEconomy/mods/forgemod_VoxelMap-*" -x "./RottenEconomy/mods/MoBends*" -x "./RottenEconomy/mods/memory_repo/*" -x "./RottenEconomy/mods/OpenSecurity/*" -x "*.git*" -x "*.log" -x "*.dat_old"
	@rm -f ./RottenEconomy
	@echo ...DONE!
